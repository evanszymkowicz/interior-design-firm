    ...
    <div className='TrendingStudies'>
      <div className='TrendingStudies-Wrapper'>
        ...
        <div className='TrendingStudies-Card'>
          <div className='TrendingStudies-CardImage TrendingStudies-CardImage1'></div>
        ...
        <div className='TrendingStudies-Card'>
          <div className='TrendingStudies-CardImage TrendingStudies-CardImage2'></div>
          <div className='TrendingStudies-CardTextBox'>
        ...
        <div className='TrendingStudies-Card'>
          <div className='TrendingStudies-CardImage TrendingStudies-CardImage3'></div>
          <div className='TrendingStudies-CardTextBox'>
        ...
        <div className='TrendingStudies-Card'>
          <div className='TrendingStudies-CardImage TrendingStudies-CardImage4'></div>
          <div className='TrendingStudies-CardTextBox'>
            <p className='TrendingStudies-CardCategory'>Workplace</p>
