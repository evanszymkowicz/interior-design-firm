    ...
    <div className='WhatsNew'>
      <div className='WhatsNew-Content'>
        <div className='WhatsNew-TextSection'>
          ...
          <p className='WhatsNew-Text' id='WhatsNew-Text'>In collaboration with Microsoft and Steelcase we have untethered teams from the traditionally limited environments so they can work together how the like: easily, actively and spontaneously
          </p>
