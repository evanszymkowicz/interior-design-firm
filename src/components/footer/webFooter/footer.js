...
export default function footer() {
  return (<div className='footer'>
    <div className='footer-wrapper'>
      <div className='footer-links'>
        <div className='footer-LinksColumn'>
          ...
          <ul className='footer-List'>
            <li className='footer-listitem'>About Starck</li>
            ...
            <li className='footer-listitem'>Starck Foundation</li>
      ...
      <p className='footer-copyright'>2019 © Starck. All Rights Reserved.</p>
...
export default function footer() {
  return (<div className='footer'>
    <div className='footer-Wrapper'>
      ...
      <p className='footer-copyright'>2019 Evan Szymkwoicz</p>
