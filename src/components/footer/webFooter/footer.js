      ...
      <div className="footer-wrapper">
        ...
        <div className="footer-Social">
          ...
          <div className="footer-SocialTags">
            <div className="footer-SocialTag footer-SocialTag1" />
            <div className="footer-SocialTag footer-SocialTag2" />
            <div className="footer-SocialTag footer-SocialTag3" />
            <div className="footer-SocialTag footer-SocialTag4" />
          </div>
