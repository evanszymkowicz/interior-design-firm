        ...
        <div className="MainGrid-Row">
          <div className="Research-Card" onMouseEnter={ToggleCard1} onMouseLeave={ToggleCard1}>
            ...
            <div className="Research-Card-Connect">
              <div className="Research-Card-ConnectItem Research-Card-ConnectItem1" />
              <div className="Research-Card-ConnectItem Research-Card-ConnectItem2" />
              <div className="Research-Card-ConnectItem Research-Card-ConnectItem3" />
              <div className="Research-Card-ConnectItem Research-Card-ConnectItem4" />
            </div>
            <div className="Research-CardTextCover" />
          </div>
