...
import './series1infobar.scss';

export default class Series1InfoBar extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ImagesTab: false,
        ...
        <div className={ImagesCardClasses}>
          <div className="InfoBar-ImagesCard-Wrapper">
            <div className="InfoBar-ImagesCard-Row">
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image1" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image2" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image3" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image4" />
            </div>
            <div className="InfoBar-ImagesCard-Row">
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image5" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image6" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image7" />
              <div className="InfoBar-ImagesCard-Image InfoBar-ImagesCard-Image8" />
            </div>
          </div>
        </div>
