...
export default function CorporatePlanning() {
  return (
    <div className="CorporatePlanning">
      <div className="CorporatePlanning-Wrapper">
        ...
        <div className="CorporatePlanning-Button">
          ...
          <div className="CorporatePlanning-ButtonIcon" />
        </div>

        <div className="CorporatePlanning-CardWrap">
          <div className="CorporatePlanning-Card">
            <div className="CorporatePlanning-CardImage CorporatePlanning-CardImage1" />
          ...
          <div className="CorporatePlanning-Card">
            <div className="CorporatePlanning-CardImage CorporatePlanning-CardImage2" />
            <div className="CorporatePlanning-CardTextBox">
          ...
          <div className="CorporatePlanning-Card">
            <div className="CorporatePlanning-CardImage CorporatePlanning-CardImage3" />
            <div className="CorporatePlanning-CardTextBox">
          ...
          <div className="CorporatePlanning-Card">
            <div className="CorporatePlanning-CardImage CorporatePlanning-CardImage4" />
            <div className="CorporatePlanning-CardTextBox">
