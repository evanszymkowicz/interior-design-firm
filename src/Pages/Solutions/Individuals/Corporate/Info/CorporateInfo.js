        ...
        <div className={ImagesCardClasses}>
          <div className="InfoBar-ImagesCard-Wrapper">
            <div className="InfoBar-ImagesCard-Row">
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image1" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image2" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image3" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image4" />
            </div>
            <div className="InfoBar-ImagesCard-Row">
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image5" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image6" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image7" />
              <div className="InfoBar-ImagesCard-Image CorporateInfoBar-ImagesCard-Image8" />
            </div>
          </div>
        </div>
