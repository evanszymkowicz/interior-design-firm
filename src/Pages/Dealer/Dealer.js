    ...
    <div className="Dealer">
      <div className="Dealer-Wrapper">
        <div className="Dealer-TitleBlock">
          <p className="Dealer-Title">Showrooms</p>
        </div>
...
AFD Contract Furniture Inc.
          ...
          <div className="Dealer-Map">
            <WrapperMap
              googleMapURL="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=AIzaSyCs0Ihg3HbUUw-Ub47aH9uqTPdwpPPHQGc"
